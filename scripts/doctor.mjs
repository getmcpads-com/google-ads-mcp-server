...
const MCP = {
  ...
  packageName: "@getmcpads/google-ads-mcp-server",
  binName: "google-ads-mcp",
  repoName: "google-ads-mcp",
  claudeKeys: ["google-ads-mcp"],
  requiredEnv: [
  ...
  optionalEnv: ["GOOGLE_ADS_LOGIN_CUSTOMER_ID", "LOG_LEVEL"],
};
